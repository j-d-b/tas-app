...
const UpcomingRestrictionsTableInfo = () => (
  <>
    ...
    <ol>
      <li style={{ marginBottom: '0.75rem' }}><div className="data-source-name">Time Slot Specific Restriction</div>There is a value set specifically for the time slot (exact date and hour). These values override all other restrictions and highlighted by <span style={{ color: '#0065ff' }}>blue text</span>.</li>
    ...
    <p>The table can also be navigated using the <code>tab</code> key. You will see the cell border highlighted when it is in focus.</p>
